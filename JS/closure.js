...
// //   if(nome == "Gabriele"){
// //   //block scope : block scope, scope globale
...
/*  Il principio di base su cui si fonda questo meccanismo stabilisce che ogni variabile che era accessibile quando una funzione è stata definita rimane "racchiusa"
    nello scope accessibile dalla funzione. 
...
function saluta(persone) {
	...
	for (let i in persone) {
		...
		saluti.push((function(nc) {  //pushiamo nell'array saluti una fuinzione immediata che ritorni una funzione che svolge il compito desiderato
						return function() { // così che bypassiamo 
